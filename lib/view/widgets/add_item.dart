...
class _AddItemShetState extends State<AddItemShet> {
  ...
  Widget build(BuildContext context) {
    return    Container(
        ...
        child: Obx(()=> leadController.isProductLoading.value ? Center(child: CircularProgressIndicator()) : Padding(
              ...
              children: [
                Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Obx(
                              ...
                              child: DropdownButton2<ProductListData>(
                                isExpanded: true,
                                items: leadController.productListData.isEmpty
                                    ? null
                                ...
                                value:
                                leadController.selectedProductData.value,
                    ...
                    CustomButton(
                      onPressed:  ()async{
                        leadController.addItemToList(productId: leadController.selectedProductData.value?.id, productName:leadController.selectedProductData.value?.name,);
                      },
                      text: Text(
                        "Add",
                        style: TextStyle(
